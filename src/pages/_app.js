...
const App = props => {
  ...
  return (
    <CacheProvider value={emotionCache}>
      <Head>
        <title>{`${themeConfig.templateName} - Ecommerce Content Management System`}</title>
        <meta
          name='description'
          content={`${themeConfig.templateName} - Ecommerce Content Management System - is a straightforward management system managing content in an ecommerce site.`}
        />
        <meta name='keywords' content='Content Management Syste, Ecommerce' />
